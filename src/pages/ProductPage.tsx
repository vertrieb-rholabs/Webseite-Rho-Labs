              ...
              <div className="space-y-10">
                <div className="flex gap-8 group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed">{"Keine Cloud-\u00DCbertragung. Alle Nutzerdaten bleiben auf Ihrem Rechner. Nach der einmaligen Lizenzaktivierung ist die Software vollst\u00E4ndig offline nutzbar."}</p>
                  </div>
                </div>
                <div className="flex gap-8 group">
